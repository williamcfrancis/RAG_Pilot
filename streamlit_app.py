...
st.info("This is a pilot project to test out Retrieval Augmented Generation (RAG) for personalized client interactions, created using LLamaIndex and GPT 3.5", icon="📃")
